...
class TypeSpecImportReferenceTest : BasePlatformTestCase() {
    ...
    fun testRelativeImportResolvesInsideQuotes() {
        myFixture.configureByFiles("imports/consumer/main.tsp", "imports/shared/widget.tsp")
        val text = myFixture.file.text
        val offset = text.indexOf("shared")
        assertTrue(offset > 0)
        ...
        assertEquals("widget.tsp", (resolved as TypeSpecFile).name)
    }
    ...
    fun testOffsetOnQuoteCharacterAndOnImportKeywordYieldNoReference() {
        ...
        val insideStringOffset = text.indexOf("shared") + 1
        assertNotNull(
